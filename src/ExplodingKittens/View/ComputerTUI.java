...
import ExplodingKittens.Controller.ComputerClient;
...
public class ComputerTUI {
    private Thread userInputThread;
    private ComputerClient playerClient;
    ...
    public ComputerTUI(ComputerClient playerClient) {
